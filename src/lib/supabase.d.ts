...
export declare const supabase: import("@supabase/supabase-js").SupabaseClient<Database, "public", "public", {
    Tables: {
        ...
        applications: {
            Row: {
                ...
                screening_answers: import("./database.types").Json;
        ...
        jobs: {
            Row: {
                benefits: import("./database.types").Json;
                city: string | null;
                closed_at: string | null;
                country: string | null;
                created_at: string;
                currency: string | null;
                dental_requirements: import("./database.types").Json;
                description: string;
        ...
        seeker_profiles: {
            Row: {
                bio: string | null;
                clinical_exposures: import("./database.types").Json | null;
                created_at: string;
                education_level: string | null;
                expected_graduation_date: string | null;
                headline: string | null;
                license_status: string | null;
                preferred_locations: import("./database.types").Json | null;
    ...
    Enums: {
        application_status: "applied" | "shortlisted" | "interview" | "offer" | "hired" | "rejected" | "withdrawn";
        doc_type: "resume" | "certificate" | "transcript" | "recommendation" | "license" | "other";
        ...
        role_type: "dentist_gp" | "dentist_specialist" | "dental_assistant" | "dental_nurse" | "dental_hygienist" | "dental_therapist" | "receptionist" | "treatment_coordinator" | "lab_technician" | "clinic_manager" | "sterilization_technician" | "other";
